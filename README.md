# Simpl-OS &nbsp; [![bluebuild build badge](https://github.com/moe-os/simpl-os/actions/workflows/build.yml/badge.svg)](https://github.com/moe-os/simpl-os/actions/workflows/build.yml)
